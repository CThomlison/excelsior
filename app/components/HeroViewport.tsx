      ...
      <div className="absolute bottom-10 left-0 right-0 z-50 pointer-events-auto flex flex-col items-center justify-end px-4">
             ...
             {hoveredSkill && (
               ...
               >
                 ...
                 <div className="flex items-start gap-4">
                    ...
                    <div className="w-12 h-12 bg-slate-50 rounded-xl overflow-hidden shadow-sm shrink-0 border border-slate-100 ring-1 ring-slate-200 flex items-center justify-center">
                        {(() => {
                          const IconComponent = (LucideIcons as any)[hoveredSkill.iconName];
                          return IconComponent ? <IconComponent size={24} className="text-slate-600" /> : null;
                        })()}
                    </div>
                    ...
                    <div className="flex-1 min-w-0">
                       ...
                       <div className="flex items-center gap-2 mt-1.5">
                          ...
                          <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                             Cooldown: {hoveredSkill.cooldown || "N/A"}
                          </span>
                       </div>
                    </div>
                 </div>
         ...
         <div className="flex items-end gap-3 md:gap-5 pb-2">
             {hero.skills.map((skill, index) => {
               ...
               const IconComponent = (LucideIcons as any)[skill.iconName];
               ...
               return (
                 ...
                 >
                    {/* The Card */}
                    <div className={cn(
                       "relative w-16 h-16 md:w-20 md:h-20 bg-white rounded-xl shadow-[0_10px_20px_rgba(0,0,0,0.08)] overflow-hidden transition-all duration-300 border-[3px] flex items-center justify-center",
                       isActive
                         ? "border-cyan-400 shadow-[0_20px_40px_rgba(6,182,212,0.25)] ring-4 ring-cyan-400/20"
                         : "border-white hover:border-cyan-100"
                    )}>
                        {IconComponent && <IconComponent size={32} className="text-slate-600" />}
